...
$story = New-ImageConsoleStory -Title 'dotnet run - ChartForgeX' -Dialect CSharp -WindowStyle WindowsTerminal -Content {
    ...
    New-ImageConsoleStoryOutput -Text 'Saved weekly-builds.png (1000 x 560)' -Style Success
}

$story | Export-ImageConsoleStory -Path $output
