@{
    ...
    CmdletsToExport        = @('Add-ImageText', 'Add-ImageTextBox', 'Add-ImageWatermark', 'Set-ImageBlur', 'Clear-ImageThumbnailCache', 'Compare-Image', 'ConvertFrom-ImageBase64', 'ConvertTo-Image', 'ConvertTo-ImageBase64', 'Export-ImageMetadata', 'Get-Image', 'Get-ImageBarCode', 'Get-ImageExif', 'Get-ImageQRCode', 'Import-ImageMetadata', 'Merge-Image', 'New-ImageAvatar', 'New-ImageBarCode', 'New-ImageChart', 'New-ImageChartAnnotation', 'New-ImageChartBar', 'New-ImageChartBarOptions', 'New-ImageChartHeatmap', 'New-ImageChartHistogram', 'New-ImageChartLine', 'New-ImageChartPie', 'New-ImageChartPolar', 'New-ImageChartRadial', 'New-ImageChartScatter', 'New-ImageCrop', 'New-ImageGif', 'New-ImageGrid', 'New-ImageIcon', 'New-ImageMosaic', 'New-ImageQRCode', 'New-ImageQRCodeBezahlCode', 'New-ImageQRCodeBitcoin', 'New-ImageQRCodeGeoLocation', 'New-ImageQRCodeGirocode', 'New-ImageQRCodeMonero', 'New-ImageQRCodeOtp', 'New-ImageQRCodePhoneNumber', 'New-ImageQRCodeShadowSocks', 'New-ImageQRCodeSkypeCall', 'New-ImageQRCodeSlovenianUpnQr', 'New-ImageQRCodeSms', 'New-ImageQRCodeSwiss', 'New-ImageQRCodeWiFi', 'New-ImageQRContact', 'New-ImageThumbnail', 'Remove-ImageExif', 'Resize-Image', 'Rotate-Image', 'Set-ImageSharpen', 'Save-Image', 'Set-ImageExif')
    CompanyName            = 'Evotec'
