@{
    ...
    CmdletsToExport        = @('ConvertTo-Image','Resize-Image','Get-Image','Get-ImageBarCode','Merge-Image','Save-Image','Get-ImageQRCode','New-ImageQRCode','New-ImageQRCodeWiFi','New-ImageBarCode')
    CompanyName            = 'Evotec'
    ...
    FunctionsToExport      = @('Get-ImageExif','New-ImageChart','New-ImageChartBar','New-ImageChartBarOptions','New-ImageChartLine','New-ImageChartPie','New-ImageChartRadial','New-ImageQRContact','Remove-ImageExif','Set-ImageExif')
