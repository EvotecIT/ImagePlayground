...
The authoring commands return reusable typed steps. `New-ImageConsoleStoryTable` accepts ordinary PowerShell objects, so examples do not need direct ChartForgeX builders or `[void]` output suppression.
