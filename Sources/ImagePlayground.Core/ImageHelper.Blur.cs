...
public partial class ImageHelper {
    ...
    public static void Blur(string filePath, string outFilePath, float? sigma = null) {
    ...
    /// </summary>
    public static async Task BlurAsync(string filePath, string outFilePath, float? sigma = null) {
        string fullPath = Helpers.ResolvePath(filePath);
        string outFullPath = Helpers.ResolvePath(outFilePath);
        Directory.CreateDirectory(Path.GetDirectoryName(outFullPath)!);
        await Task.Run(() => {
