...
internal partial class Example {
    /// <summary>
    /// Placeholder for image cropping experiments.
    /// </summary>
    /// <param name="folderPath">Working directory for test images.</param>
    public static void ImageCropping(string folderPath) {
