...
///   <code>$upn = [CodeMatrix.Payloads.SlovenianUpnQrPayload]::new('Payer','Addr','City','Rec','RAddr','RCity','SI123','Desc',1);New-ImageQRCodeSlovenianUpnQr -Payload $upn -FilePath upn.png</code>
/// </example>
